...
if(WALLET.type=="http"){wallet.web3=new Web3(new Web3.providers.HttpProvider(WALLET[WALLET.net][WALLET.type]));setInterval(()=>{wallet.update();mainUpdate()},2000)}else{wallet.web3=new Web3(new Web3.providers.WebsocketProvider(WALLET[WALLET.net][WALLET.type]));wallet.web3.eth.subscribe('newBlockHeaders',wallet.update)}
